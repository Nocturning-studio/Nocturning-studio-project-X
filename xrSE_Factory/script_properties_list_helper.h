...
struct CScriptPropertiesListHelper
{
  ...
  public:
    ...
    ChooseValue *CreateChoose(PropItemVec *items, LPCSTR key, luabind::object object, LPCSTR name, u32 mode,
                              LPCSTR path);
    ChooseValue *CreateChoose(PropItemVec *items, LPCSTR key, luabind::object object, LPCSTR name, u32 mode,
                              LPCSTR path, LPCSTR fill_param);
    ChooseValue *CreateChoose(PropItemVec *items, LPCSTR key, luabind::object object, LPCSTR name, u32 mode,
                              LPCSTR path, LPCSTR fill_param, u32 sub_item_cnt);

    //			S8Value* 			CreateS8		    (PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR
    //name); 			S8Value* 			CreateS8		    (PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR
    //name, s8 mn); 			S8Value* 			CreateS8		    (PropItemVec* items, LPCSTR key, luabind::object object,
    //LPCSTR name, s8 mn, s8 mx); 			S8Value* 			CreateS8		    (PropItemVec* items, LPCSTR key, luabind::object
    //object, LPCSTR name, s8 mn, s8 mx, s8 inc);
    ...
    Token8Value *CreateToken8(PropItemVec *items, LPCSTR key, luabind::object object, LPCSTR name,
                              CScriptTokenList *token);
    Token16Value *CreateToken16(PropItemVec *items, LPCSTR key, luabind::object object, LPCSTR name,
                                CScriptTokenList *token);
    Token32Value *CreateToken32(PropItemVec *items, LPCSTR key, luabind::object object, LPCSTR name,
                                CScriptTokenList *token);
    //			RToken8Value* 		CreateRToken8	    (PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR
    //name, RTokenVec* token); 			RToken16Value* 		CreateRToken16	    (PropItemVec* items, LPCSTR key, luabind::object
    ...
    RListValue *CreateRList(PropItemVec *items, LPCSTR key, luabind::object object, LPCSTR name,
    ...
    //name, ListItem* owner); 			RTextValue* 		CreateNameCB		(PropItemVec* items, LPCSTR key, luabind::object
    //object, LPCSTR name, TOnDrawTextEvent=0, RTextValue::TOnBeforeEditEvent=0, RTextValue::TOnAfterEditEvent=0);
