...
IC void CObjectFactory::add(const CLASS_ID &clsid, LPCSTR script_clsid)
{
    //	{
    //		typedef
    //object_type_traits::is_base_and_derived<CLIENT_BASE_CLASS,CType<_client_type,_server_type,CLIENT_BASE_CLASS>::type>
    //a; 		STATIC_CHECK	(a::value,Client_class_must_be_derived_from_the_CLIENT_BASE_CLASS);
    //	}
    //	{
    //		typedef
    //object_type_traits::is_base_and_derived<SERVER_BASE_CLASS,CType<_client_type,_server_type,SERVER_BASE_CLASS>::type>
    //a; 		STATIC_CHECK	(a::value,Server_class_must_be_derived_from_the_SERVER_BASE_CLASS);
    //	}
    //	add
    //(xr_new<CObjectItemCS<CType<_client_type,_server_type,CLIENT_BASE_CLASS>::type,CType<_client_type,_server_type,SERVER_BASE_CLASS>::type>
    //>(clsid,script_clsid));
