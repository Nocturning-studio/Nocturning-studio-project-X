...
struct ref_sound
{
  ...
  public:
    ...
    */
    ...
    IC void play_at_pos(CObject *O /*!< Object */, const Fvector &pos /*!< 3D position */,
                        u32 flags = 0 /*!< Looping */, float delay = 0.f /*!< Delay */);
    IC void play_no_feedback(CObject *O /*!< Object */, u32 flags = 0 /*!< Looping */, float delay = 0.f /*!< Delay */,
                             Fvector *pos = 0, float *vol = 0, float *freq = 0, Fvector2 *range = 0);
    //@}
