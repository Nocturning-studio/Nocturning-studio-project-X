    ...
    module(L)
        [class_<PropValue>("prop_value"), class_<PropItemVec>("prop_item_vec"), class_<CaptionValue>("caption_value"),
         ...
         class_<CChooseType>("choose_type")
             .enum_(
                 "choose_type")[value("custom", int(smCustom)), value("sound_source", int(smSoundSource)),
         ...
         class_<CScriptPropertiesListHelper>("properties_list_helper")
             ...
             //luabind::object , LPCSTR ))					(&CScriptPropertiesListHelper::CreateS8)) 			.def("create_s8",
             //(S8Value *(CScriptPropertiesListHelper::*)(PropItemVec*, LPCSTR,  luabind::object , LPCSTR ,  s8))
             ...
             .def("create_s16",
                  (S16Value * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object, LPCSTR, s16,
                                                               s16))(&CScriptPropertiesListHelper::CreateS16))
             .def("create_s16",
             ...
             .def("create_s32",
                  (S32Value * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object, LPCSTR, s32,
                                                               s32))(&CScriptPropertiesListHelper::CreateS32))
             .def("create_s32",
             ...
             .def("create_u8",
                  (U8Value * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object, LPCSTR, u8, u8,
                                                              u8))(&CScriptPropertiesListHelper::CreateU8))
             ...
             .def("create_u16",
                  (U16Value * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object, LPCSTR, u16,
                                                               u16))(&CScriptPropertiesListHelper::CreateU16))
             .def("create_u16",
             ...
             .def("create_u32",
                  (U32Value * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object, LPCSTR, u32,
                                                               u32))(&CScriptPropertiesListHelper::CreateU32))
             .def("create_u32",
             ...
             .def("create_float",
                  (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object, LPCSTR, float,
                                                                 float))(&CScriptPropertiesListHelper::CreateFloat))
             .def("create_float", (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object,
                                                                                 LPCSTR, float, float, float))(
                                      &CScriptPropertiesListHelper::CreateFloat))
             .def("create_float", (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object,
                                                                                 LPCSTR, float, float, float, int))(
                                      &CScriptPropertiesListHelper::CreateFloat))
             ...
             .def("create_vector",
                  (VectorValue * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object, LPCSTR, float,
                                                                  float, float,
                                                                  int))(&CScriptPropertiesListHelper::CreateVector))
             ...
             .def("create_flag8", (Flag8Value * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object,
                                                                                 LPCSTR, u8, LPCSTR, LPCSTR))(
                                      &CScriptPropertiesListHelper::CreateFlag8))
             .def("create_flag8", (Flag8Value * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object,
                                                                                 LPCSTR, u8, LPCSTR, LPCSTR, u32))(
                                      &CScriptPropertiesListHelper::CreateFlag8))
             ...
             .def("create_flag16",
                  (Flag16Value * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object, LPCSTR, u16,
                                                                  LPCSTR, LPCSTR,
                                                                  u32))(&CScriptPropertiesListHelper::CreateFlag16))
             ...
             .def("create_time",
                  (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object, LPCSTR,
                                                                 float))(&CScriptPropertiesListHelper::CreateTime))
             .def("create_time",
                  (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object, LPCSTR, float,
                                                                 float))(&CScriptPropertiesListHelper::CreateTime))
             ...
             .def("create_angle",
                  (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object, LPCSTR, float,
                                                                 float))(&CScriptPropertiesListHelper::CreateAngle))
             .def("create_angle", (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object,
                                                                                 LPCSTR, float, float, float))(
                                      &CScriptPropertiesListHelper::CreateAngle))
             .def("create_angle", (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object,
                                                                                 LPCSTR, float, float, float, int))(
             ...
             .def("create_vangle",
                  (VectorValue * (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR, luabind::object, LPCSTR, float,
                                                                  float, float,
                                                                  int))(&CScriptPropertiesListHelper::CreateAngle3))
