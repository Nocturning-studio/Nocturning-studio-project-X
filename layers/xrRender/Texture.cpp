...
IDirect3DTexture9* TW_LoadTextureFromTexture(IDirect3DTexture9* t_from, D3DFORMAT& t_dest_fmt, int levels_2_skip,
											 u32& w, u32& h)
{
...
template <class _It> IC void TW_Iterate_1OP(IDirect3DTexture9* t_dst, IDirect3DTexture9* t_src, const _It pred)
{
...
template <class _It>
IC void TW_Iterate_2OP(IDirect3DTexture9* t_dst, IDirect3DTexture9* t_src0, IDirect3DTexture9* t_src1, const _It pred)
{
	DWORD mips = t_dst->GetLevelCount();
