...
float ps_r2_bloom_kernel_g = 5.0f;
float ps_r2_bloom_kernel_b = 1.0f;
float ps_r2_bloom_speed = 1.f;
float ps_r2_bloom_kernel_scale = 2.0f; // gauss
float ps_r2_bloom_threshold = 0.8f;
float ps_r2_bloom_factor = 0.4f;
