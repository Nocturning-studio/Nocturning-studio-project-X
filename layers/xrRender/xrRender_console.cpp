...
xr_token r1_aa_transluency_token[] = {
	{"st_opt_disabled", 0}, 
	{"st_opt_ssaa", trans_ssaa_fmt}, // õâàòèò êîììåíòèðîâàòü ýòîò ðåæèì, îí ìíå íóæåí
...
float ps_r2_sun_depth_far_bias = -0.002f;
float ps_r2_sun_depth_middle_scale = 1.0000f;
float ps_r2_sun_depth_middle_bias = -0.0001;
...
void xrRender_initconsole()
{
	...
	CMD4(CCC_Float, "r2_sun_depth_middle_scale", &ps_r2_sun_depth_middle_scale, 0.5, 1.5);
	CMD4(CCC_Float, "r2_sun_depth_middle_bias", &ps_r2_sun_depth_middle_bias, -0.5, +0.5);
