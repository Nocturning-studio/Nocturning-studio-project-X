...
void CBlender_accum_spot::Compile(CBlender_Compile& C)
{
	...
	case SE_L_UNSHADOWED: // unshadowed
		C.r_Pass("accumulating_light_stage_volume", "accumulating_light_stage_spot_unshadowed", false, FALSE, FALSE,
	...
	case SE_L_NORMAL: // normal
		C.r_Pass("accumulating_light_stage_volume", "accumulating_light_stage_spot_normal", false, FALSE, FALSE, TRUE,
	...
	case SE_L_FULLSIZE: // normal-fullsize
		C.r_Pass("accumulating_light_stage_volume", "accumulating_light_stage_spot_fullsize", false, FALSE, FALSE, TRUE,
				 D3DBLEND_ONE, D3DBLEND_ONE);
		C.r_Sampler_rtf("s_gbuffer_position", r2_RT_GBuffer_Position);
		C.r_Sampler_rtf("s_gbuffer_normal", r2_RT_GBuffer_Normal);
		C.r_Sampler_rtf("s_gbuffer_albedo", r2_RT_GBuffer_Albedo);
