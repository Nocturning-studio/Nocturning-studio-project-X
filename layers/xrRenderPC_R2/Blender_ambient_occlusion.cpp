...
void CBlender_ambient_occlusion::Compile(CBlender_Compile& C)
{
	...
	case 2:
		...
		break;
	case 3:
		C.r_Pass("null", "ambient_occlusion_blurring_stage_pass_diagonal_filter", FALSE, FALSE, FALSE);
		C.r_Sampler_clf("s_ao", r2_RT_ao_base);
		jitter(C);
		C.r_End();
		break;
	case 4:
		C.r_Pass("null", "ambient_occlusion_blurring_stage_pass_strided_filter", FALSE, FALSE, FALSE);
