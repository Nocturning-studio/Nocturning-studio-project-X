		...
		namespace detail
		{
			...
			public:
				...
				inline u32 size() const
				{
					...
					if (result > max_concat_result_size) { error_process(); }
			...
			private:
				...
				struct helper
				{
					...
					static inline const char* string(const char* string) { return (string); }

					static inline u32 length(shared_str const& string) { return (string.size()); }

					static inline const char* string(shared_str const& string) { return (string.c_str()); }

					static inline u32 length(xr_string const& string) { return (string.size()); }

					static inline const char* string(xr_string const& string) { return (string.c_str()); }
