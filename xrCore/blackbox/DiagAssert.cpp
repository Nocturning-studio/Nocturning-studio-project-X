...
extern BOOL __stdcall CH_ReadProcessMemory(HANDLE, LPCVOID lpBaseAddress, LPVOID lpBuffer, DWORD nSize,
...
#error( "Unknown machine!" )
        ...
        {
            if (FALSE == StackWalk(dwMachine, hProcess, hThread, &stFrame, &stCtx,
                                   (PREAD_PROCESS_MEMORY_ROUTINE)CH_ReadProcessMemory, SymFunctionTableAccess,
