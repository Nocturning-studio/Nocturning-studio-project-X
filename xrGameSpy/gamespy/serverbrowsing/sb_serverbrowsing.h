...
#define ServerBrowserGetServerByIP ServerBrowserGetServerByIPW
    ...
    ServerBrowser ServerBrowserNew(const gsi_char *queryForGamename, const gsi_char *queryFromGamename,
                                   const gsi_char *queryFromKey, int queryFromVersion, int maxConcUpdates,
    ...
    */
    ...
    SBError ServerBrowserAuxUpdateIP(ServerBrowser sb, const gsi_char *ip, unsigned short port, SBBool viaMaster,
    ...
    SBError ServerBrowserSendNatNegotiateCookieToServer(ServerBrowser sb, const gsi_char *ip, unsigned short port,
                                                        int cookie);

    /* ServerBrowserSendMessageToServer
    ------------------
    Sends a game-specific message to a server  */
    SBError ServerBrowserSendMessageToServer(ServerBrowser sb, const gsi_char *ip, unsigned short port,
    ...
    */
    ...
    const gsi_char *SBServerGetTeamStringValue(SBServer server, int teamnum, const gsi_char *key,
                                               const gsi_char *sdefault);
