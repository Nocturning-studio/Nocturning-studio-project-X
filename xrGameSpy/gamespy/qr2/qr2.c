...
extern "C"
{
    ...
    qr2_error_t qr2_initW(/*[out]*/ qr2_t *qrec, const unsigned short *ip, int baseport, const unsigned short *gamename,
                          const unsigned short *secret_key, int ispublic, int natnegotiate,
                          ...
                          qr2_countcallback_t playerteam_count_callback, qr2_adderrorcallback_t adderror_callback,
                          void *userdata);
    ...
    qr2_error_t qr2_init_socketA(/*[out]*/ qr2_t *qrec, SOCKET s, int boundport, const char *gamename,
                                 const char *secret_key, int ispublic, int natnegotiate,
                                 qr2_serverkeycallback_t server_key_callback,
                                 qr2_playerteamkeycallback_t player_key_callback,
                                 qr2_playerteamkeycallback_t team_key_callback, qr2_keylistcallback_t key_list_callback,
                                 qr2_countcallback_t playerteam_count_callback,
                                 qr2_adderrorcallback_t adderror_callback, void *userdata);
    qr2_error_t qr2_initA(/*[out]*/ qr2_t *qrec, const char *ip, int baseport, const char *gamename,
                          const char *secret_key, int ispublic, int natnegotiate,
                          qr2_serverkeycallback_t server_key_callback, qr2_playerteamkeycallback_t player_key_callback,
                          qr2_playerteamkeycallback_t team_key_callback, qr2_keylistcallback_t key_list_callback,
                          qr2_countcallback_t playerteam_count_callback, qr2_adderrorcallback_t adderror_callback,
    ...
    ********/
                                 ...
                                 qr2_adderrorcallback_t adderror_callback, void *userdata)
    {
        ...
        return qr2_init_socketA(qrec, s, boundport, gamename_A, secretkey_A, ispublic, natnegotiate,
                                server_key_callback, player_key_callback, team_key_callback, key_list_callback,
                                playerteam_count_callback, adderror_callback, userdata);
    }
                          ...
                          void *userdata)
    {
        ...
        ret = qr2_init_socketA(qrec, hbsock, baseport, gamename, secret_key, ispublic, natnegotiate,
                               server_key_callback, player_key_callback, team_key_callback, key_list_callback,
                               playerteam_count_callback, adderror_callback, userdata);
        if (qrec == NULL)
            qrec = &current_rec;
...
#ifndef GSI_UNICODE
                qrec->adderror_callback(e_qrnochallengeerror, "No challenge value was received from the master server.",
                                        qrec->udata);
#else
            qrec->adderror_callback(e_qrnochallengeerror, L"No challenge value was received from the master server.",
                                    qrec->udata);
#endif
                return;
            }
...
#define MAX_CHALLENGE 64
    ...
    static void qr_build_partial_query_reply(qr2_t qrec, qr2_buffer_t buf, qr2_key_type keytype, int keycount,
                                             uchar *keys)
    {
    ...
    static void qr_process_query(qr2_t qrec, qr2_buffer_t buf, uchar *qdata, int len, struct sockaddr *sender)
    {
        ...
        else
        {
            ...
            qr_build_query_reply(qrec, buf, serverkeycount, serverkeys, playerkeycount, playerkeys, teamkeycount,
                                 teamkeys);
            sendto(qrec->hbsock, buf->buffer, buf->len, 0, sender, sizeof(struct sockaddr_in));
        }
