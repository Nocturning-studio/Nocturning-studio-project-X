...
MEM_CHUNK *MEM_CHUNK_POOLAllocChunk(
    MEM_CHUNK_POOL *_this, size_t Size, int Alignment,
...
void MEM_CHUNK_POOLFillMemoryTable(MEM_CHUNK_POOL *_this, char *Table, const int TableSize, gsi_u32 _HeapStart,
                                   gsi_u32 _HeapSize);
