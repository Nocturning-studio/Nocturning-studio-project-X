...
#define GS_XML_MAX_ATTRIBUTE_VALUE_LENGTH 1024
    ...
    gsi_bool gsXmlWriteBase64BinaryElement(GSXmlStreamWriter stream, const char *namespaceName, const char *tag,
                                           const gsi_u8 *data, int len);
    gsi_bool gsXmlWriteDateTimeElement(GSXmlStreamWriter stream, const char *namespaceName, const char *tag,
                                       time_t value);
    ...
    gsi_bool gsXmlReadChildAsBase64Binary(GSXmlStreamReader stream, const char *matchtag, gsi_u8 valueOut[],
                                          int *lenOut);
