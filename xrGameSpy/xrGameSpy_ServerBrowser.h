...
extern "C"
{
    ...
    EXPORT_FN_DECL(SBError, ServerBrowserUpdate,
    ...
    EXPORT_FN_DECL(const gsi_char *, SBServerGetStringValue,
    ...
    EXPORT_FN_DECL(SBError, ServerBrowserAuxUpdateServer,
                   (ServerBrowser sb, SBServer server, SBBool async, SBBool fullUpdate));
    EXPORT_FN_DECL(SBError, ServerBrowserAuxUpdateIP,
                   (ServerBrowser sb, const gsi_char *ip, unsigned short port, SBBool viaMaster, SBBool async,
                    SBBool fullUpdate));

    EXPORT_FN_DECL(const gsi_char *, SBServerGetPlayerStringValue,
    ...
    EXPORT_FN_DECL(double, SBServerGetPlayerFloatValue,
                   (SBServer server, int playernum, const gsi_char *key, double fdefault));

    EXPORT_FN_DECL(const gsi_char *, SBServerGetTeamStringValue,
    ...
    EXPORT_FN_DECL(double, SBServerGetTeamFloatValue,
    ...
    EXPORT_FN_DECL(SBBool, SBServerGetConnectionInfo,
    ...
    EXPORT_FN_DECL(void, ServerBrowserSort,
