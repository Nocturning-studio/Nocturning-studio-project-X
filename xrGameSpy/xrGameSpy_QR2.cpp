...
XRGAMESPY_API qr2_error_t xrGS_qr2_init(/*[out]*/ qr2_t *qrec, const gsi_char *ip, int baseport, int ispublic,
                                        int natnegotiate, qr2_serverkeycallback_t server_key_callback,
                                        ...
                                        qr2_adderrorcallback_t adderror_callback, void *userdata)
{
    ...
    qr2_error_t res = qr2_init(qrec, ip, BasePort, GAMESPY_GAMENAME, SecretKey, ispublic, natnegotiate,
