...
class ENGINE_API R_constant_table : public xr_resource_flagged
{
  ...
  private:
	...
	BOOL parseConstants(ID3D11ShaderReflectionConstantBuffer* pTable, u32 destination);
	BOOL parseResources(ID3D11ShaderReflection* pReflection, int ResNum, u32 destination);
...
#include "dx11/ConstantBuffer_impl.h"
