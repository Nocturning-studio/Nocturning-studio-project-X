...
//—пасибо Morrey из проекта которого € вз€л функцию, 
//	Maks0 за переделку под определение количества €дер процессора и 
//	использвани€ соответствующего числа потоков и VAX, который доделал функцию
