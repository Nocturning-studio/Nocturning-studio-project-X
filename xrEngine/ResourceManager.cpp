...
//#define MT_TEXTURES - Deathman: Не эффективно при работе с жесткими дисками - мы ограничены возможностью чтения. Мы не можем грузить текстуры четырьмя потоками, потому что они все тупо ждут
