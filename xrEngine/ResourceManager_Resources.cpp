...
#endif
		HRESULT const _hr = ::Render->shader_compile(name, (DWORD const*)data, (UINT)size, c_entry, c_target,
...
#endif
		HRESULT const _hr =
			::Render->shader_compile(name, (DWORD const*)data, (UINT)size, c_entry, c_target,
									 D3DXSHADER_PACKMATRIX_ROWMAJOR | D3DXSHADER_PACKMATRIX_COLUMNMAJOR, (void*&)_ps);
