...
void WeaponUsageStatistic::LoadFile(char *FileName)
{
    ...
    {
        _GetName(LevelName, &ptmpFileName);
        ptmpFileName++;
...
void WeaponUsageStatistic::Load(FILE *pFile)
{
    ...
    DbgOut("\tm_dwTotalPlayersAliveTime - %d, %d, %d\n", m_dwTotalPlayersAliveTime[0], m_dwTotalPlayersAliveTime[1],
           m_dwTotalPlayersAliveTime[2]);
    ...
    DbgOut("\tm_dwTotalPlayersMoneyRound - %d, %d, %d\n", m_dwTotalPlayersMoneyRound[0], m_dwTotalPlayersMoneyRound[1],
    ...
    DbgOut("\tm_dwTotalNumRespawns - %d, %d, %d\n", m_dwTotalNumRespawns[0], m_dwTotalNumRespawns[1],
           m_dwTotalNumRespawns[2]);
    //----------------------------------------------
    u32 NumPlayers;
