...
void dx10ShaderResourceStateCache::SetHSResource( u32 uiSlot, ID3D11ShaderResourceView	*pRes )
{
...
void dx10ShaderResourceStateCache::SetDSResource( u32 uiSlot, ID3D11ShaderResourceView	*pRes )
{
	VERIFY(uiSlot<CBackend::mtMaxHullShaderTextures);
...
void dx10ShaderResourceStateCache::SetCSResource( u32 uiSlot, ID3D11ShaderResourceView	*pRes )
{
