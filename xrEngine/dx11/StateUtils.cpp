...
void ResetDescription( D3D11_RASTERIZER_DESC &desc )
{
...
void ResetDescription( D3D11_DEPTH_STENCIL_DESC &desc )
{
	ZeroMemory(&desc, sizeof(desc));
...
void ResetDescription( D3D11_BLEND_DESC &desc )
{
	ZeroMemory(&desc, sizeof(desc));
...
void ResetDescription( D3D11_SAMPLER_DESC &desc )
{
	ZeroMemory(&desc, sizeof(desc));
...
bool operator==(const D3D11_RASTERIZER_DESC &desc1, const D3D11_RASTERIZER_DESC &desc2)
{
...
bool operator==(const D3D11_DEPTH_STENCIL_DESC &desc1, const D3D11_DEPTH_STENCIL_DESC &desc2)
{
...
bool operator==(const D3D11_BLEND_DESC &desc1, const D3D11_BLEND_DESC &desc2)
{
...
bool operator==(const D3D11_SAMPLER_DESC &desc1, const D3D11_SAMPLER_DESC &desc2)
{
...
u32 GetHash( const D3D11_RASTERIZER_DESC &desc )
{
	dxHashHelper	Hash;
...
u32 GetHash( const D3D11_DEPTH_STENCIL_DESC &desc )
{
	dxHashHelper	Hash;
...
u32 GetHash( const D3D11_BLEND_DESC &desc )
{
	dxHashHelper	Hash;
...
u32 GetHash( const D3D11_SAMPLER_DESC &desc )
{
	dxHashHelper	Hash;
...
void ValidateState(D3D11_RASTERIZER_DESC &desc)
{
}

void ValidateState(D3D11_DEPTH_STENCIL_DESC &desc)
{
...
void ValidateState(D3D11_BLEND_DESC &desc)
{
	...
	for ( int i=0; i<8; ++i)
	{
		...
		else
		{
			...
			case D3D11_BLEND_SRC_COLOR:
				desc.RenderTarget[i].SrcBlendAlpha = D3D11_BLEND_SRC_ALPHA;
				break;
			case D3D11_BLEND_INV_SRC_COLOR:
				desc.RenderTarget[i].SrcBlendAlpha = D3D11_BLEND_INV_SRC_ALPHA;
				break;
			case D3D11_BLEND_DEST_COLOR:
				desc.RenderTarget[i].SrcBlendAlpha = D3D11_BLEND_DEST_ALPHA;
				break;
			case D3D11_BLEND_INV_DEST_COLOR:
				desc.RenderTarget[i].SrcBlendAlpha = D3D11_BLEND_INV_DEST_ALPHA;
				break;
			case D3D11_BLEND_SRC1_COLOR:
				desc.RenderTarget[i].SrcBlendAlpha = D3D11_BLEND_SRC1_ALPHA;
				break;
			case D3D11_BLEND_INV_SRC1_COLOR:
				desc.RenderTarget[i].SrcBlendAlpha = D3D11_BLEND_INV_SRC1_ALPHA;
					break;
			}
			...
			{
			case D3D11_BLEND_SRC_COLOR:
				desc.RenderTarget[i].DestBlendAlpha = D3D11_BLEND_SRC_ALPHA;
				break;
			case D3D11_BLEND_INV_SRC_COLOR:
				desc.RenderTarget[i].DestBlendAlpha = D3D11_BLEND_INV_SRC_ALPHA;
				break;
			case D3D11_BLEND_DEST_COLOR:
				desc.RenderTarget[i].DestBlendAlpha = D3D11_BLEND_DEST_ALPHA;
				break;
			case D3D11_BLEND_INV_DEST_COLOR:
				desc.RenderTarget[i].DestBlendAlpha = D3D11_BLEND_INV_DEST_ALPHA;
				break;
			case D3D11_BLEND_SRC1_COLOR:
				desc.RenderTarget[i].DestBlendAlpha = D3D11_BLEND_SRC1_ALPHA;
				break;
			case D3D11_BLEND_INV_SRC1_COLOR:
				desc.RenderTarget[i].DestBlendAlpha = D3D11_BLEND_INV_SRC1_ALPHA;
				break;
			}
		}
	}
...
void ValidateState(D3D11_SAMPLER_DESC &desc)
{
