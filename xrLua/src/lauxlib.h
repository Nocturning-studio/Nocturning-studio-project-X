...
LUALIB_API int(LUA_CC luaL_checkoption)(lua_State *L, int narg, const char *def, const char *const lst[]);
...
LUALIB_API int(LUA_CC luaL_loadbuffer)(lua_State *L, const char *buff, size_t sz, const char *name);
LUALIB_API int(LUA_CC luaL_loadstring)(lua_State *L, const char *s);

LUALIB_API lua_State *(LUA_CC luaL_newstate)(void);

LUALIB_API const char *(LUA_CC luaL_gsub)(lua_State *L, const char *s, const char *p, const char *r);

LUALIB_API const char *(LUA_CC luaL_findtable)(lua_State *L, int idx, const char *fname);
