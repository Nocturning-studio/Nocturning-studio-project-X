...
static int co_create(lua_State *L)
{
    ...
    luaL_argcheck(L, lua_isfunction(L, 1) && (cstacksize >= 0 ? 1 : !lua_iscfunction(L, 1)), 1,
...
static luaL_Reg co_lib[] = {{"resume", co_resume}, {"yield", co_yield },          {"create", co_create},
                            {"wrap", co_wrap},     {"cstacksize", co_cstacksize}, {NULL, NULL}};
