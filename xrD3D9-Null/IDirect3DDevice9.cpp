...
HRESULT xrIDirect3DDevice9::CreateAdditionalSwapChain(D3DPRESENT_PARAMETERS *pPresentationParameters,
...
HRESULT xrIDirect3DDevice9::Present(CONST RECT *pSourceRect, CONST RECT *pDestRect, HWND hDestWindowOverride,
                                    CONST RGNDATA *pDirtyRegion)
{
    APIDEBUG("xrIDirect3DDevice9::Present");
    return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetBackBuffer(UINT iSwapChain, UINT iBackBuffer, D3DBACKBUFFER_TYPE Type,
...
HRESULT xrIDirect3DDevice9::CreateVertexBuffer(UINT Length, DWORD Usage, DWORD FVF, D3DPOOL Pool,
...
HRESULT xrIDirect3DDevice9::UpdateTexture(IDirect3DBaseTexture9 *pSourceTexture,
...
HRESULT xrIDirect3DDevice9::CreateOffscreenPlainSurface(UINT Width, UINT Height, D3DFORMAT Format, D3DPOOL Pool,
                                                        IDirect3DSurface9 **ppSurface, HANDLE *pSharedHandle)
{
...
HRESULT xrIDirect3DDevice9::Clear(DWORD Count, CONST D3DRECT *pRects, DWORD Flags, D3DCOLOR Color, float Z,
                                  DWORD Stencil)
{
...
HRESULT xrIDirect3DDevice9::DrawIndexedPrimitive(D3DPRIMITIVETYPE, INT BaseVertexIndex, UINT MinVertexIndex,
                                                 UINT NumVertices, UINT startIndex, UINT primCount)
{
    APIDEBUG("xrIDirect3DDevice9::DrawIndexedPrimitive");
    return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::DrawPrimitiveUP(D3DPRIMITIVETYPE PrimitiveType, UINT PrimitiveCount,
...
HRESULT xrIDirect3DDevice9::CreateVertexDeclaration(CONST D3DVERTEXELEMENT9 *pVertexElements,
...
HRESULT xrIDirect3DDevice9::SetStreamSource(UINT StreamNumber, IDirect3DVertexBuffer9 *pStreamData, UINT OffsetInBytes,
                                            UINT Stride)
{
    APIDEBUG("xrIDirect3DDevice9::SetStreamSource");
    return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetStreamSource(UINT StreamNumber, IDirect3DVertexBuffer9 **ppStreamData,
