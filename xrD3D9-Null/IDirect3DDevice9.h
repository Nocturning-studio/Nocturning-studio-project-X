...
extern "C"
{
    ...
    class xrIDirect3DDevice9 : public IDirect3DDevice9
    {
      ...
      public:
        ...
        HRESULT __stdcall UpdateTexture(IDirect3DBaseTexture9 *pSourceTexture,
        ...
        HRESULT __stdcall Clear(DWORD Count, CONST D3DRECT *pRects, DWORD Flags, D3DCOLOR Color, float Z,
                                DWORD Stencil);
        ...
        HRESULT __stdcall DrawIndexedPrimitive(D3DPRIMITIVETYPE, INT BaseVertexIndex, UINT MinVertexIndex,
        ...
        HRESULT __stdcall SetStreamSource(UINT StreamNumber, IDirect3DVertexBuffer9 *pStreamData, UINT OffsetInBytes,
                                          UINT Stride);
        HRESULT __stdcall GetStreamSource(UINT StreamNumber, IDirect3DVertexBuffer9 **ppStreamData,
