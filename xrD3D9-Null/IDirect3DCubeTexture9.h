...
extern "C"
{
    ...
    class xrIDirect3DCubeTexture9 : public IDirect3DCubeTexture9
    {
      ...
      public:
        xrIDirect3DCubeTexture9(IDirect3DDevice9 *pIDirect3DDevice9, UINT iWidth, UINT iHeight, UINT iLevels,
        ...
        HRESULT __stdcall GetCubeMapSurface(D3DCUBEMAP_FACES FaceType, UINT Level,
                                            IDirect3DSurface9 **ppCubeMapSurface);
        HRESULT __stdcall LockRect(D3DCUBEMAP_FACES FaceType, UINT Level, D3DLOCKED_RECT *pLockedRect,
