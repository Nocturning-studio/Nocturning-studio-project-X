...
class CGameSpy_GCD_Server
{
  ...
  private:
    ...
    GAMESPY_FN_VAR_DECL(void, gcd_authenticate_user,
                        (int localid, unsigned int userip, char *challenge, char *response, fnAuthCallBackFn authfn,
                         fnRefreshAuthCallBackFn refreshfn, void *instance));
