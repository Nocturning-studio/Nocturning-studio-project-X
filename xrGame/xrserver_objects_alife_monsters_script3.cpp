...
{
	module(L)[luabind_class_creature1(CSE_ALifeCreatureAbstract, "cse_alife_creature_abstract",
...
{
	module(L)[luabind_class_dynamic_alife2(CSE_ALifeOnlineOfflineGroup, "cse_alife_online_offline_group",
