...
class CALifeCombatManager : public virtual CALifeSimulatorBase, CRandom
{
    ...
    *tpALifeSchedulable1,		CSE_ALifeSchedulable	*tpALifeSchedulable2); bool bfCheckForInteraction
    (CSE_ALifeSchedulable		*tpALifeSchedulable1,		CSE_ALifeSchedulable	*tpALifeSchedulable2,			int
    &iCombatGroupIndex,			bool					&bMutualDetection); void
    vfPerformAttackAction		(int						iCombatGroupIndex); bool
