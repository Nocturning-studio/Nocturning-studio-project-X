...
IC CAgentManagerPropertyEvaluatorEnemy::CAgentManagerPropertyEvaluatorEnemy(CAgentManager *object,
                                                                            LPCSTR evaluator_name)
    : inherited(object, evaluator_name)
{
}

IC CAgentManagerPropertyEvaluatorDanger::CAgentManagerPropertyEvaluatorDanger(CAgentManager *object,
                                                                              LPCSTR evaluator_name)
    : inherited(object, evaluator_name)
{
}
