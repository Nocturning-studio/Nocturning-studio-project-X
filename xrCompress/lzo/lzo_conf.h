...
#if defined(LZO_BYTE_ORDER)
#if (LZO_BYTE_ORDER != LZO_LITTLE_ENDIAN) && (LZO_BYTE_ORDER != LZO_BIG_ENDIAN)
...
#define __LZO_QUERY_COMPRESS(i, il, o, ol, w, n, s) (*ol = (n) * (s), LZO_E_OK)

#define __LZO_IS_DECOMPRESS_QUERY(i, il, o, ol, w) ((lzo_voidp)(o) == (w))
#define __LZO_QUERY_DECOMPRESS(i, il, o, ol, w, n, s) (*ol = (n) * (s), LZO_E_OK)

#define __LZO_IS_OPTIMIZE_QUERY(i, il, o, ol, w) ((lzo_voidp)(o) == (w))
#define __LZO_QUERY_OPTIMIZE(i, il, o, ol, w, n, s) (*ol = (n) * (s), LZO_E_OK)
