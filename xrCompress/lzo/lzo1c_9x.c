...
LZO_EXTERN(int)
lzo1c_999_compress_callback(const lzo_byte *in, lzo_uint in_len, lzo_byte *out, lzo_uintp out_len, lzo_voidp wrkmem,
...
LZO_PUBLIC(int)
lzo1c_999_compress(const lzo_byte *in, lzo_uint in_len, lzo_byte *out, lzo_uintp out_len, lzo_voidp wrkmem)
{
    return lzo1c_999_compress_callback(in, in_len, out, out_len, wrkmem, (lzo_progress_callback_t)0, 0);
}
