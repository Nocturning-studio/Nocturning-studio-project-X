...
#if 0
#define HEAD3(b, p) ((((((lzo_uint32)b[p] << 3) ^ b[p + 1]) << 3) ^ b[p + 2]) & (SWD_HSIZE - 1))
#endif
...
LZO_EXTERN(int)
lzo1x_999_compress_internal(const lzo_byte *in, lzo_uint in_len, lzo_byte *out, lzo_uintp out_len, lzo_voidp wrkmem,
                            const lzo_byte *dict, lzo_uint dict_len, lzo_progress_callback_t cb, int try_lazy,
                            lzo_uint good_length, lzo_uint max_lazy, lzo_uint nice_length, lzo_uint max_chain,
                            lzo_uint32 flags);
...
static lzo_byte *code_match(LZO_COMPRESS_T *c, lzo_byte *op, lzo_uint m_len, lzo_uint m_off)
{
...
static lzo_byte *STORE_RUN(LZO_COMPRESS_T *c, lzo_byte *op, const lzo_byte *ii, lzo_uint t)
{
    c->lit_bytes += t;
...
static lzo_byte *code_run(LZO_COMPRESS_T *c, lzo_byte *op, const lzo_byte *ii, lzo_uint lit, lzo_uint m_len)
{
    if (lit > 0)
    {
        assert(m_len >= 2);
...
#if !defined(NDEBUG)
static void assert_match(const lzo_swd_t *swd, lzo_uint m_len, lzo_uint m_off)
{
...
static void better_match(const lzo_swd_t *swd, lzo_uint *m_len, lzo_uint *m_off)
{
#if defined(LZO1Z)
    const LZO_COMPRESS_T *c = swd->c;
#endif
...
LZO_PUBLIC(int)
lzo1x_999_compress_level(const lzo_byte *in, lzo_uint in_len, lzo_byte *out, lzo_uintp out_len, lzo_voidp wrkmem,
                         const lzo_byte *dict, lzo_uint dict_len, lzo_progress_callback_t cb, int compression_level)
{
    static const struct
    {
        int try_lazy;
...
LZO_PUBLIC(int)
lzo1x_999_compress_dict(const lzo_byte *in, lzo_uint in_len, lzo_byte *out, lzo_uintp out_len, lzo_voidp wrkmem,
...
LZO_PUBLIC(int)
lzo1x_999_compress(const lzo_byte *in, lzo_uint in_len, lzo_byte *out, lzo_uintp out_len, lzo_voidp wrkmem)
{
    return lzo1x_999_compress_level(in, in_len, out, out_len, wrkmem, NULL, 0, 0, 8);
}
