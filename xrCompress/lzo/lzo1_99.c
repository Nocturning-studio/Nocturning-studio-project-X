...
static int _lzo1_do_compress(const lzo_byte *in, lzo_uint in_len, lzo_byte *out, lzo_uintp out_len, lzo_voidp wrkmem,
                             lzo_compress_t func)
{
    int r;
...
#define LZO_COMPRESS _LZO_ECONCAT3(lzo1_, COMPRESS_ID, _compress)

#define LZO_COMPRESS_FUNC _LZO_ECONCAT3(_lzo1_, COMPRESS_ID, _compress_func)
